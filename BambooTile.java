...
public class BambooTile extends RankTile {
	...
	public void paintComponent(Graphics g) {
		...
		if (rank == 2) {
			...
			yStart = 15;
			colors = new Color[]{new Color(24,0,117), new Color(0,68,68)};
			drawVerticalBamboo(2, xStart, yStart, colors, g);
		} else if (rank == 3) {
			xStart = (WIDTH - 10) / 2 + 2;
			yStart = 35;
			drawBamboo(xStart, yStart, new Color(0,68,68), g);
			drawBamboo(xStart + 20, yStart, new Color(0,68,68), g);
			drawBamboo(xStart + 10, yStart - 20, new Color(24,0,117), g);
		} else if (rank == 4) {
			xStart = (WIDTH - 10) / 2;
			yStart = 15;
			colors = new Color[]{new Color(24,0,117), new Color(0,68,68)};
			...
			colors = new Color[]{new Color(0,68,68), new Color(24,0,117)};
			drawVerticalBamboo(2, xStart, yStart, colors, g);
		} else if (rank == 5) {
			xStart = 20;
			yStart = 15;
			...
			xStart = 35;
			yStart = 25;
			drawBamboo(xStart, yStart,  new Color(152,15,36), g);
		} else if (rank == 6) {
			xStart = 20;
			yStart = 15;
			colors = new Color[]{new Color(0,68,68), new Color(24,0,117)};
			...
			xStart = 20;
			yStart = 23;
			colors = new Color[]{new Color(0,68,68)};
			drawVerticalBamboo(2, xStart, yStart, colors, g);
			drawVerticalBamboo(2, xStart + 30, yStart, colors, g);
			xStart = 35;
			yStart = 3;
			colors = new Color[]{ new Color(152,15,36), new Color(24,0,117), new Color(24,0,117)};
			...
			drawAngledBamboo(xStart + 9, yStart, 45, new Color(0,68,68), g);
			drawAngledBamboo(xStart + 3, yStart + 5, -45, new Color(0,68,68), g);
			drawAngledBamboo(xStart + 6, yStart + 20, 45, new Color(24,0,117), g);
			drawAngledBamboo(xStart - 33, yStart + 25, -45, new Color(24,0,117), g);
		} else if (rank == 9) {
			xStart = 20;
			yStart = 3;
			colors = new Color[]{new Color(152,15,36)};
			drawVerticalBamboo(3, xStart, yStart, colors, g);
			xStart = 35;
			colors = new Color[]{new Color(24,0,117)};
			drawVerticalBamboo(3, xStart, yStart, colors, g);
			xStart = 50;
			colors = new Color[]{new Color(0,68,68)};
			drawVerticalBamboo(3, xStart, yStart, colors, g);
	...
	private void drawBamboo(int xStart, int yStart, Color c, Graphics g) {
		...
		g.setColor(c.equals(Color.WHITE) ? Color.BLACK : Color.WHITE);
	...
	private void drawAngledBamboo(int xStart, int yStart, int slope, Color c, Graphics g) {
		...
		graphics.setColor(c.equals(Color.WHITE) ? Color.BLACK : Color.WHITE);
