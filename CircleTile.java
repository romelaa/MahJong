...
public class CircleTile extends RankTile {
	...
	public void paintComponent(Graphics g) {
        ...
        if (rank == 1) {
            ...
            size = 13;
            g.setColor(new Color(152,15,36));
        ...
        if (rank == 2) {
            ...
            yStart = 8;
            spacing = 4;
            drawVerticalCircles(size, 2, xStart, yStart, spacing, new Color[]{new Color(0,68,68), new Color(152,15,36)}, g);
        }
        if (rank == 3) {
            size = 17;
            xStart = 13;
            yStart = 8;
            colors = new Color[]{new Color(24,0,117), new Color(152,15,36), new Color(0,68,68)};
        ...
        if (rank == 4) {
            ...
            yStart = 8;
            spacing = 4;
            drawVerticalCircles(23, 2, xStart, yStart, spacing, new Color[]{new Color(24,0,117), new Color(0,68,68)}, g);
            drawVerticalCircles(23, 2, xStart + size, yStart, spacing, new Color[]{new Color(0,68,68), new Color(24,0,117)}, g);
        }
        if (rank == 5) {
            size = 17;
            xStart = 12;
        ...
        if (rank == 6) {
            ...
            yStart = 6;
            spacing = 2;
            colors = new Color[]{new Color(0,68,68), new Color(152,15,36), new Color(152,15,36)};
        ...
        if (rank == 9) {
            ...
            yStart = 5;
            spacing = 2;
            colors = new Color[]{new Color(0,68,68), new Color(152,15,36), new Color(24,0,117)};
            drawVerticalCircles(size, 3, xStart, yStart, spacing, colors, g);
