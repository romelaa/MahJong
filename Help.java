...
public class Help extends JPanel implements HyperlinkListener
{
	...
	public Help(String file, String title)
	{
		...
		frame = new JFrame();
		URL	url = Help.class.getResource("Java_Icons/general/Help24.gif");
		...
		JButton	close = ButtonFactory.makeImageButton("/Java_icons/general/Stop24.gif", "Close the help system",
				"close", this, true);
	...
	public Help(String file)
	{
		...
		back = ButtonFactory.makeImageButton("/Java_Icons/navigation/Back24.gif", "Return to the previous help page", "back", this, true);
		next = ButtonFactory.makeImageButton("/Java_Icons/navigation/Forward24.gif", "Goto the next help page", "forward", this, true);
